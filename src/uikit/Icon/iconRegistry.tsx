 ...
 * Triggers the same action as click when Enter or Space is pressed
 */
const handleKeyDown = (
...
/**
 * Icon registry that creates a Map of icon factory functions.
 * Icons are only created when requested via the factory function.
 * This prevents creating all 94+ icons when you only need one.
 * All icons are accessibility-compliant with:
 * - role="img" for screen readers
 * - aria-label with descriptive name
 * - title element for tooltips
 * - tabIndex for keyboard navigation
 * - onKeyDown handler for keyboard interaction (Enter/Space)
 */
export function getIconRegistry(props: IconRegistryProps): Map<string, UIIcon> {
	const {
		size,
		stroke,
		strokeColor,
			...
			"sink",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Sink Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Sink Icon</title>
						<path
							d="M15 4.5H20"
							stroke={strokeColor}
							strokeWidth={stroke}
			...
			"lift",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Lift Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Lift Icon</title>
						<path
							d="M4 4.5H9"
							stroke={strokeColor}
							strokeWidth={stroke}
			...
			"font smaller",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Font Smaller Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Font Smaller Icon</title>
						<path d="M 0 0 L 20 0 L 20 20 L 0 20 Z" fill="transparent" />
						<path
			...
			"font larger",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Font Larger Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Font Larger Icon</title>
						<path d="M 0 0 L 20 0 L 20 20 L 0 20 Z" fill="transparent" />
						<path
			...
			"globe location",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Globe Location Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Globe Location Icon</title>
			...
			"chart arrow",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Chart Arrow Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Chart Arrow Icon</title>
						<path d="M 0 0 L 20 0 L 20 20 L 0 20 Z" fill="transparent" />
			...
			"document editor",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Document Editor Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Document Editor Icon</title>
						<g>
							<defs>
								<path
			...
			"character beam",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Character Beam Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Character Beam Icon</title>
						<path d="M 0 0 L 24 0 L 24 24 L 0 24 Z" fill="transparent" />
			...
			"compliance check",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Compliance Check Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Compliance Check Icon</title>
						<path
			...
			"concise",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Concise Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Concise Icon</title>
						<path
			...
			"open circle",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Open Circle Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Open Circle Icon</title>
						<path
			...
			"dollar",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Trash Bin Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Trash Bin Icon</title>
						<path d="M 1 1 L 19 1 L 19 19 L 1 19 Z" fill="transparent" />
						<path
			...
			"trash bin",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Recent Chats Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Recent Chats Icon</title>
						<path
			...
			"arrow left",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Gpmark Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Gpmark Icon</title>
						<path
			...
			"attach",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Ctrl Key Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Ctrl Key Icon</title>
						<g clipPath="url(#a)">
							<path
			...
			"share",
			{
				line: () => (
					<svg
						...
						xmlns="http://www.w3.org/2000/svg"
						role="img"
						aria-label="G-p Assist Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>G-p Assist Icon</title>
						<path
			...
			"unchecked",
			{
				line: () => (
					<svg
						...
						fill="none"
						role="img"
						aria-label="Partial Icon"
						tabIndex={pointer && !disabled ? 0 : -1}
						onKeyDown={(e) => handleKeyDown(e, onClick)}
					>
						<title>Partial Icon</title>
						<rect
							x="2.75"
							y="2.75"
							width="14.5"
