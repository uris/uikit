...
export function UIFileIcon(props: UIFileIconProps) {
  const {
    name = 'document',
    size = 20,
    pointer = false,
        ...
        icon: (
          ...
          >
            ...
            <path
              ...
              fill={theme.lyraColors['core-icon-light']}
            ></path>
            <path
              d="M 13 1 L 15 3 L 17 5 L 14 5 C 13.448 5 13 4.552 13 4 Z"
              fill={theme.brand['brand-purple-300']}
            ></path>
          </svg>
        ),
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M 4.5 19 L 15.5 19 C 16.328 19 17 18.328 17 17.5 L 17 5 L 14.5 5 C 13.672 5 13 4.328 13 3.5 L 13 1 L 4.5 1 C 3.672 1 3 1.672 3 2.5 L 3 17.5 C 3 18.328 3.672 19 4.5 19 Z"
              fill={theme.brand['brand-land-700']}
            ></path>
            <path
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M 4.5 19 L 15.5 19 C 16.328 19 17 18.328 17 17.5 L 17 5 L 14.5 5 C 13.672 5 13 4.328 13 3.5 L 13 1 L 4.5 1 C 3.672 1 3 1.672 3 2.5 L 3 17.5 C 3 18.328 3.672 19 4.5 19 Z"
              fill={theme.lyraColors['core-badge-primary']}
            ></path>
            <path
              d="M 6 14 L 14 14 M 6 10 L 12 10"
              fill="transparent"
              strokeWidth="1.5"
              stroke={theme.lyraColors['core-icon-light']}
              strokeMiterlimit="10"
              strokeDasharray=""
            ></path>
            <path
  ...
  }, [size, disabled, onClick, pointer, theme]);
