...
export const light: Colors = {
	...
	'core-text-accent': coreColors['brand-sky-500'],
...
export const dark: Colors = {
	...
	'core-text-accent': coreColors['brand-sky-300'],
...
export const colorCssVars: Record<keyof Colors, string> = {
	...
	'core-text-accent': 'var(--core-text-accent)',
...
export const colorClass: Record<keyof Colors, string> = {
	...
	'core-text-accent': 'core-text-accent',
